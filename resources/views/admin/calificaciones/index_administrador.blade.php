        ...
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title">Listado de Calificaciones por Grupo Academico Registrados</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-hover table-striped table-sm">
                        ...
                        @foreach ($grupos as $grupo)
                         <tr>
                            ...
                            <td>
                                <a href="{{ url('/admin/calificaciones/grupo/'.$grupo->id) }}" class="btn btn-info"><i class="fas fa-eye"></i> Ver Calificaciones</a>
                            </td>
                         </tr>
