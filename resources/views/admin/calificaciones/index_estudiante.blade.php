...
@section('content_header')
    <h1><b>Calificaciones del Estudiante: {{ $estudiante->apellidos . ' ' . $estudiante->nombres }} </b></h1>
    <hr>
@stop
        ...
        <div class="col-md-8">
            <div class="accordion" id="accordionExample">
                @foreach ($matriculas as $matricula)
                    <div class="card">
                        <div class="card-header" style="background-color: #c3e6cf" id="heading{{ $matricula->id }}">
                            <h2 class="mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($matricula->asignacionMaterias as $asignacion)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('/admin/calificaciones/detalle_calificacion/estudiante/'.$estudiante->id.'/grupo_academico/'.$asignacion->grupo_academico->id) }}" class="btn btn-success">
