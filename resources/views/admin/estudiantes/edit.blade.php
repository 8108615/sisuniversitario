...
@section('content_header')
    <h1>Estudiantes/Editar Datos del Estudiantes</h1>
    <hr>
@stop
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="nombres" id="nombres"
                                            value="{{ old('nombres',$estudiante->nombres) }}" placeholder="Escriba aqui..." required>
                                    </div>
                                    @error('nombres')
                                        <small style="color: red;">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="apellidos" id="apellidos"
                                            value="{{ old('apellidos',$estudiante->apellidos) }}" placeholder="Escriba aqui..." required>
                                    </div>
                                    @error('apellidos')
                                        <small style="color: red;">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="ci" id="ci"
                                            value="{{ old('ci',$estudiante->ci) }}" placeholder="Escriba aqui..." required>
                                    </div>
                                    @error('ci')
                                        <small style="color: red;">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="telefono" id="telefono"
                                            value="{{ old('telefono',$estudiante->telefono) }}" placeholder="Escriba aqui..." required>
                                    </div>
                                    @error('telefono')
                                        <small style="color: red;">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="ref_celular" id="ref_celular"
                                            value="{{ old('ref_celular',$estudiante->ref_celular) }}" placeholder="Escriba aqui..." required>
                                    </div>
                                    @error('ref_celular')
                                        <small style="color: red;">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="parentesco" id="parentesco"
                                            value="{{ old('parentesco',$estudiante->parentesco) }}" placeholder="Escriba aqui..." required>
                                    </div>
                                    @error('parentesco')
                                        <small style="color: red;">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="email" class="form-control" name="email" id="email"
                                            value="{{ old('email',$estudiante->usuario->email) }}" placeholder="Escriba aqui..." required>
                                    </div>
                                    @error('email')
                                        <small style="color: red;">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="profesion" id="profesion"
                                            value="{{ old('profesion',$estudiante->profesion) }}" placeholder="Escriba aqui..." required>
                                    </div>
                                    @error('profesion')
                                        <small style="color: red;">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" class="form-control" name="direccion" id="direccion"
                                            value="{{ old('direccion',$estudiante->direccion) }}" placeholder="Escriba aqui..." required>
                                    </div>
                                    @error('direccion')
                                        <small style="color: red;">{{ $message }}</small>
                                    @enderror
