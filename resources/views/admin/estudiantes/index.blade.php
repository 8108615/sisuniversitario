                    ...
                    <table id="example1" class="table table-bordered table-hover table-striped table-sm">
                        ...
                        @foreach($estudiantes as $estudiante)
                            <tr>
                                ...
                                <td>{{ $estudiante->usuario->roles->pluck('name')->implode(', ') }}</td>
                                ...
                                <td style="text-align: center">
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <a href="{{url('/admin/estudiantes/'.$estudiante->id)}}" class="btn btn-info btn-sm"><i class="fas fa-eye"></i></a>
                                        <a href="{{url('/admin/estudiantes/'.$estudiante->id.'/edit')}}" class="btn btn-success btn-sm"><i class="fas fa-pencil-alt"></i></a>
